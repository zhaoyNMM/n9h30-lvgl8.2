...
C_DEPS += \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_arc.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_blend.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_dither.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_gradient.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_img.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_letter.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_line.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_polygon.d \
./packages/LVGL-v8.2.0/src/draw/sw/lv_draw_sw_rect.d 


# Each subdirectory must supply rules for building sources it contributes
packages/LVGL-v8.2.0/src/draw/sw/%.o: ../packages/LVGL-v8.2.0/src/draw/sw/%.c
