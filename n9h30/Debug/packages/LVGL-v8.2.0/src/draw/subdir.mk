...
C_DEPS += \
./packages/LVGL-v8.2.0/src/draw/lv_draw.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_arc.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_img.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_label.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_line.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_mask.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_rect.d \
./packages/LVGL-v8.2.0/src/draw/lv_draw_triangle.d \
./packages/LVGL-v8.2.0/src/draw/lv_img_buf.d \
./packages/LVGL-v8.2.0/src/draw/lv_img_cache.d \
./packages/LVGL-v8.2.0/src/draw/lv_img_decoder.d 


# Each subdirectory must supply rules for building sources it contributes
packages/LVGL-v8.2.0/src/draw/%.o: ../packages/LVGL-v8.2.0/src/draw/%.c
