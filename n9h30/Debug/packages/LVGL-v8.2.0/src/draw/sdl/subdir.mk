...
C_DEPS += \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_arc.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_bg.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_composite.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_img.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_label.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_line.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_mask.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_polygon.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_rect.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_stack_blur.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_texture_cache.d \
./packages/LVGL-v8.2.0/src/draw/sdl/lv_draw_sdl_utils.d 


# Each subdirectory must supply rules for building sources it contributes
packages/LVGL-v8.2.0/src/draw/sdl/%.o: ../packages/LVGL-v8.2.0/src/draw/sdl/%.c
