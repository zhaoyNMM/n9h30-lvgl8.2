...
LV_IMG_DECLARE(power_host );
 ...
 void lvgl_power_style(void)
 {
         ...
         //瀛椾綋
     lv_style_init(&style_power_Font1);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font1, lv_color_white());//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font1, &lv_font_montserrat_46); /* 璁剧疆椋庢牸瀛椾綋 */

     lv_style_init(&style_power_Font2);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font2, lv_color_white());//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font2, &lv_font_montserrat_26); /* 璁剧疆椋庢牸瀛椾綋 */

     lv_style_init(&style_power_Font3);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font3, lv_color_white());//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font3, &lv_font_montserrat_14); /* 璁剧疆椋庢牸瀛椾綋 */

     lv_style_init(&style_power_Font4);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font4, lv_color_white());//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font4, &lv_font_montserrat_22); /* 璁剧疆椋庢牸瀛椾綋 */



     lv_style_init(&style_power_Font5);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font5, lv_color_make(0x7e, 0xce, 0xf4));//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font5, &lv_font_montserrat_14); /* 璁剧疆椋庢牸瀛椾綋 */

     lv_style_init(&style_power_Font6);/* 鏍峰紡鍒濆鍖� */
     lv_style_set_text_color(&style_power_Font6, lv_color_make(0x87, 0x97, 0xcb));//璁剧疆瀛椾綋棰滆壊
     lv_style_set_text_font(&style_power_Font6, &lv_font_montserrat_14); /* 璁剧疆椋庢牸瀛椾綋 */
 ...
 static void event_switch_cb1(lv_event_t* e)
 {
     ...
     if(reverse)
     {
         ...
         lv_label_set_text(label_ch1_w, "0.0059");
     ...
     else
     {
         ...
         lv_label_set_text(label_ch1_w, "0.0000");
 ...
 static void event_switch_cb2(lv_event_t* e)
 {
     ...
     if(reverse)
     {
         ...
         lv_label_set_text(label_ch2_w, "0.0089");
     ...
     else
     {
         ...
         lv_label_set_text(label_ch2_w, "0.0000");
...
void power_init(lv_obj_t*obj)
{
    ...
    lv_obj_align(label_ch1_v, LV_ALIGN_CENTER, -215, -95);/* 设置标签位置 */
    ...
    lv_obj_align(label_ch2_v, LV_ALIGN_CENTER, 195, -95);/* 设置标签位置 */
